...
summary: "A well-performing UK kitchen appliance affiliate blog lost 91% of its top-3 keywords in two weeks. Screaming Frog identified the cause: a content restructure that returned 403 Forbidden on the structural ranking assets and blocked 523 image files simultaneously. The rollback was not implemented."
cover:
  image: ""
  alt: ""
  caption: ""
...
On November 28, 2021, organic traffic collapsed sharply. The owner reached out in February 2022 unable to identify the cause.
...
Roll back to the prior URL structure to restore indexed paths, then rebuild the architecture correctly from a stable baseline. The rollback was not implemented. The engagement concluded at the diagnostic stage.
